        ...
        if (client.readyState == 4 && client.status == 200) {
            ...
            if(Object.keys(productos).length > 0) {
                productos.forEach(registro => {
                    ...
                    descripcion = '';
                    descripcion += '<li>precio: ' + registro.precio + '</li>';
                    descripcion += '<li>unidades: ' + registro.unidades + '</li>';
                    descripcion += '<li>modelo: ' + registro.modelo + '</li>';
                    descripcion += '<li>marca: ' + registro.marca + '</li>';
                    descripcion += '<li>detalles: ' + registro.detalles + '</li>';
